        ...
        namespace KITTI {
            ...
            int LabelsIO::ReadLabels(const std::string &filename, std::vector<TrackingLabel> &labels) {
                ...
                while (getline (file,line)) {
                    ...
                    for (auto &c:type) c = std::toupper(c);
            ...
            int LabelsIO::WriteLabels(std::vector<TrackingLabel> &labels, const std::string &filename) {
                ...
                for (const auto &label:labels) {
                    ...
                    if (label.type==CAR) {
                        category_string = "Car";
                    } else if (label.type==VAN) {
                        category_string = "Van";
                    } else if (label.type==TRUCK) {
                        category_string = "Truck";
                    } else if (label.type==PEDESTRIAN) {
                        category_string = "Pedestrian";
                    } else if (label.type==PERSON_SITTING) {
                        category_string = "Person_Sitting";
                    } else if (label.type==CYCLIST) {
                        category_string = "Cyclist";
                    } else if (label.type==TRAM) {
                        category_string = "Tram";
                    } else if (label.type==MISC) {
                        category_string = "Misc";
                    } else if (label.type==DONT_CARE) {
