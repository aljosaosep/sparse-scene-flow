    ...
    namespace utils {
        ...
        public:
           ...
           */
            ...
            /**
              * @brief compute the 3d camera coordinates of the point in 2d image plane
              * @param u,v Coordinates of the pixe; in the image domain
              * @returns 3d point in camera coordinates
              * @author Alina Shigabudnova
              */
            Eigen::Vector3d BackprojectTo3D(const double u, const double v, const double depth) const;
